 ...
 * 
 * Note that a header file might also include a header file, which recursively includes headers (also called transitive includes).
 * Also note that header files are not included in compilation. It is handled by the preprocessor.
 */
