...
int main() {
    ...
    // Copy initialization
    // Copy-initialization has fallen out of favor due to being less efficient, but a lot of the issues have been remedied since C++17.
    int b = 5;
    ...
    // behaves consistently, and has an unambiguous syntax that makes it easy to tell where we’re initializing an object.
    int d {7};
