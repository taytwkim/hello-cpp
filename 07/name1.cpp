...
// use the scope resolution operator (::) without specifying the namespace to look up the GLOBAL
// namespace
...
int main()
{
    ...
    // and if the namespace ever changes, we can update the alias instead of updating every place
