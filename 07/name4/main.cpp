 ...
 * unnamed namespaces are defined without a name. The function can be accessible from the parent
 namespace.
 ...
 * Like in unnamed namespaces, any identifier declared in inline namespaces is accessible from the
 parent namespace.
