...
int main()
{
    ...
    // This is because cout is buffered, which means the the message might not be displayed right
    // away. On the other hand, cerr is not buffered, so the messages will be visible right away -
    // easier to trace the source of the problem.
