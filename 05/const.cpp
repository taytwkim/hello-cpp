...
void gravity()
{
    ...
    // 1. It reduces the chance of bugs - the compiler will complain if a constant variable is overwritten accidentally.
    // 2. If the compiler knows that the variable is constant, it can perform additional optimizations
