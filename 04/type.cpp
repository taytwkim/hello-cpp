...
void typeof_demo()
{
    ...
    // C++ only guarantees that integers will have a certain minimum size, not that they will have a
    // specific size. So when we print the size of "long" and "long long", they may actually be the
    // same though they have different "minimum size".
